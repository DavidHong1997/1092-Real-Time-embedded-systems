...
static  void  TaskStartCreateTasks (void)
{
        OSTaskCreate(Task1, (void *)0, &Task1_Stk[TASK_STK_SIZE], 1, 1, 4); // Init comptime & deadline in TCB
        OSTaskCreate(Task2, (void *)0, &Task2_Stk[TASK_STK_SIZE], 2, 2, 5);// (prio, comptimr, deadline)
